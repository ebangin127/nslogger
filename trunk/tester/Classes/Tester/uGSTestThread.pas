...
begin
  ...
  begin
    case FExitCode of
      EXIT_HOSTWRITE:
      begin
        AddToAlert(GetLogLine('���� ����'));
      end;
      EXIT_RETENTION:
      begin
        AddToAlert(GetLogLine('�ֱ��� ���ټ� �׽�Ʈ'));
      end;
      EXIT_EXT_RETENTION:
      begin
        AddToAlert(GetLogLine('���ټ� �׽�Ʈ ���� ����'));
      end;
      EXIT_ERROR:
      begin
        AddToAlert(GetLogLine('���� ������ ������'));
...
begin
  ...
  begin
    ...
    begin
      ...
      AddToAlert(GetLogLine(IntToStr(FLastSyncCount) + 'ȸ ����',
                            '�ݺ��� ��ġ - ' + IntToStr(FTester.Iterator)));
    end;
